...
## 46.1 Alignment with Core 0.4.1

This release aligns Optional with SPEC.md Core 0.4.1.

Capabilities now defined directly by Core — including stable requirement IDs, living specifications, modular Specification Sets, Given / When / Then acceptance criteria, verification linkage, composed-behavior verification, and human-only comments — are not redefined here.
