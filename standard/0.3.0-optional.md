---
specmd_optional: "0.3.0"
status: draft
title: "SPEC.md Optional"
companion_to: "SPEC.md Standard 0.3.0"
tagline: "Portable Ideas and Designs."
last_updated: "2026-09-11"
---

# SPEC.md Optional 0.3.0

**Status:** Draft  
**Companion to:** SPEC.md Standard 0.3.0  
**Tagline:** **Portable Ideas and Designs.**
...
`SPEC.md Optional` defines optional extensions, authoring patterns, and companion artifacts that may improve the clarity, rigor, traceability, maintainability, or implementation usability of a SPEC.md.

The Core SPEC.md standard remains intentionally small.

A project MAY use any subset of the optional conventions in this document.

A project MUST NOT include an optional section merely to satisfy a template.

Use optional rigor only when it materially improves the ability of a human or LLM to understand, implement, verify, maintain, or reuse the design.
...
# 2. Stable Requirement Identifiers

A project MAY assign stable semantic identifiers to normative requirements.
...
# 10. Specification Sets and Modular Composition

A larger design MAY use a root SPEC.md plus normative modules.
...
# 11. Specification Set Version Metadata

The root SPEC.md normally owns the `spec_version` for the complete Specification Set.
...
# 25. Given / When / Then Acceptance Notes

Behaviorally significant requirements MAY include readable acceptance criteria.
...
# 31. Living-Spec Workflow

A project MAY use SPEC.md as a living specification that grows with the implementation.

A living-spec workflow may begin with:

- frontmatter;
- Specification Contract;
- empty Core sections.

As behavior is implemented or decided, requirements are added or updated in the same change.
...
- MUST NOT influence implementation;
- MUST NOT influence ambiguity resolution;
- MUST NOT influence conformance.

Tooling SHOULD physically remove these blocks before sending SPEC.md to an LLM.

Human-only blocks MUST NOT contain information necessary for implementation or verification.
...
Assumptions are context, not requirements, unless a normative statement explicitly depends on them.
