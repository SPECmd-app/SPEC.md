...
This specification is version **0.1.4** and is currently a **draft**.

It conforms to **SPEC.md Core 0.4.2**. The Core version and this Judo Club specification version are intentionally independent.
...
## 8.2 Version 0.1.4 Clarification

Version 0.1.4 does not change the required behavior of the Judo Club Website.

It updates the document to SPEC.md Core 0.4.2. Required website behavior is unchanged, so this is a PATCH-level change.
