...
Normative terms used in this document:

- **MUST / MUST NOT** — mandatory for conformance.
- **SHOULD / SHOULD NOT** — recommended unless there is a justified reason to deviate.
- **MAY** — optional.
...
- Language switching MUST preserve the visitor's current logical page whenever an equivalent page exists.
...
## 2.3 Representation Conventions
...
When a visitor switches language, the destination MUST represent the same logical page whenever an equivalent exists.
...
Interactive controls MUST be operable using a keyboard where the platform supports keyboard interaction.
...
- primary interactive controls are keyboard operable;
...
## 8.2 Why the Exact Technology Is Not Specified
...
## 8.3 Why Contact Data Is Not Stored
...
## 8.4 Why SEO/GEO Is Not Included
...
## 8.5 Why the Gallery Is Included
...
6. Implement Contact form validation and external handoff.
